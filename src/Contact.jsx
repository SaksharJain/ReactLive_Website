...
return{
    ...
    const formSubmit =(e)=>{
        e.preventDefault();
        alert(`My name is ${data.fullname}.My moblie number is ${data.phone} and email is ${data.email},Here is what I want to say ${data.msg} `);
    };
  ...
  <div class="mb-3">
    ...
    <input type="number" class="form-control" id="exampleFormControlInput1" name="phone" value={data.phone} onChange={InputEvent} placeholder="moblie number"/>
  </div>
  <div class="mb-3">
